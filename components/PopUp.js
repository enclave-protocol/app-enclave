                ...
                <div className='content'>
                  ...
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke={theme.icon.menu} strokeOpacity="0.74" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round"/>
                    <path d="M12 9V13" stroke={theme.icon.menu} strokeOpacity="0.74" strokeWidth="2" strokeLinecap="round"
                          strokeLinejoin="round"/>
                    <path d="M12 17H12.01" stroke={theme.icon.menu} strokeOpacity="0.74" strokeWidth="2" strokeLinecap="round"
                          strokeLinejoin="round"/>
                  </svg>

                  <h2>Not available in Alpha version</h2>
                </div>
                <Button className='button__modal'>JOIN BETA TEST</Button>
              </div>
            </section>
        </motion.div>
